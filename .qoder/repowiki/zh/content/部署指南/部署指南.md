...
- [user-docs/INDEX.md](file://user-docs/INDEX.md)
</cite>

## 更新摘要
**所做更改**
- 更新了与新文档索引和导航结构相协调的部署指南内容
- 增强了与 VitePress 新配置的集成说明
- 完善了多应用部署策略与文档体系的关联
- 优化了 CLI 工具与部署流程的整合
...
**更新** 本指南现已与新的 VitePress 文档索引和导航结构相协调，确保文档体系的完整性。
...
Docs --> VitePress["VitePress 配置<br/>.vitepress/config.js"]
Docs --> Deployment["部署指南<br/>guide/deployment.md"]
Docs --> GettingStarted["快速开始<br/>guide/getting-started.md"]
Docs --> APIRef["API 参考<br/>api/README.md"]
```
...
- [packages/main-app/src/core/microAppManager.js:1-515](file://packages/main-app/src/core/microAppManager.js#L1-L515)
...
- [packages/iframe-sub-app/vite.config.js:1-28](file://packages/iframe-sub-app/vite.config.js#L1-L28)
- [user-docs/.vitepress/config.js:1-79](file://user-docs/.vitepress/config.js#L1-L79)
...
**更新** 新的文档结构提供了更清晰的导航和索引，便于运维人员查找相关部署信息。

**章节来源**
- [packages/main-app/package.json:1-31](file://packages/main-app/package.json#L1-L31)
- [packages/vue3-sub-app/package.json:1-23](file://packages/vue3-sub-app/package.json#L1-L23)
...
- 端口与服务
  ...
  - iframe 子应用：Vite 监听 9080 端口，多入口构建。
- 启动方式
  - 启动全部应用：并行启动主应用与各子应用。
  - 单独启动：按需启动主应用或特定子应用。
- 调试要点
...
**更新** 端口配置已更新，iframe 子应用现在使用 9080 端口而非 4000 端口。
...
- [packages/vue3-sub-app/vite.config.js:25-37](file://packages/vue3-sub-app/vite.config.js#L25-L37)
- [packages/vue2-sub-app/vue.config.js:7-16](file://packages/vue2-sub-app/vue.config.js#L7-L16)
- [packages/iframe-sub-app/vite.config.js:6-17](file://packages/iframe-sub-app/vite.config.js#L6-L17)
...
**更新** 新的部署指南文档提供了更详细的 Nginx 配置示例和 CORS 设置说明。
...
- [user-docs/guide/deployment.md:3-18](file://user-docs/guide/deployment.md#L3-L18)
- [user-docs/guide/deployment.md:20-65](file://user-docs/guide/deployment.md#L20-L65)
- [user-docs/guide/deployment.md:88-112](file://user-docs/guide/deployment.md#L88-L112)
...
**更新** 新的文档结构提供了更清晰的多应用部署策略说明，与 VitePress 导航保持一致。

**章节来源**
- [packages/main-app/src/config/microApps.js:1-184](file://packages/main-app/src/config/microApps.js#L1-L184)
- [user-docs/guide/deployment.md:114-130](file://user-docs/guide/deployment.md#L114-L130)
- [user-docs/guide/deployment.md:67-86](file://user-docs/guide/deployment.md#L67-L86)
...
**更新** Docker 部署建议与新的文档索引结构保持一致，便于运维人员查找相关部署信息。

**章节来源**
- [user-docs/guide/deployment.md:132-145](file://user-docs/guide/deployment.md#L132-L145)
...
**图表来源**
- [packages/main-app/src/core/microAppManager.js:49-165](file://packages/main-app/src/core/microAppManager.js#L49-L165)
- [packages/main-app/src/core/microAppManager.js:173-232](file://packages/main-app/src/core/microAppManager.js#L173-L232)
...
**更新** 子应用配置已更新，iframe 子应用现在使用 9080 端口。

**章节来源**
- [packages/vue3-sub-app/vite.config.js:6-24](file://packages/vue3-sub-app/vite.config.js#L6-L24)
- [packages/vue2-sub-app/vue.config.js:13-23](file://packages/vue2-sub-app/vue.config.js#L13-L23)
- [packages/iframe-sub-app/vite.config.js:13-27](file://packages/iframe-sub-app/vite.config.js#L13-L27)
...
- [packages/main-app/vite.config.js:1-46](file://packages/main-app/vite.config.js#L1-L46)
- [packages/vue3-sub-app/package.json:12-16](file://packages/vue3-sub-app/package.json#L12-L16)
- [packages/vue3-sub-app/vite.config.js:1-46](file://packages/vue3-sub-app/vite.config.js#L1-L46)
- [packages/vue2-sub-app/package.json:11-16](file://packages/vue2-sub-app/package.json#L11-L16)
- [packages/vue2-sub-app/vue.config.js:1-25](file://packages/vue2-sub-app/vue.config.js#L1-L25)
- [packages/iframe-sub-app/package.json:1-15](file://packages/iframe-sub-app/package.json#L1-L15)
- [packages/iframe-sub-app/vite.config.js:1-28](file://packages/iframe-sub-app/vite.config.js#L1-L28)
- [packages/cli/package.json:5-7](file://packages/cli/package.json#L5-L7)
...
**更新** 性能优化建议与新的文档结构保持一致，便于运维人员参考相关最佳实践。

**章节来源**
- [packages/main-app/vite.config.js:32-44](file://packages/main-app/vite.config.js#L32-L44)
- [user-docs/guide/deployment.md:37-42](file://user-docs/guide/deployment.md#L37-L42)
- [packages/main-app/src/core/microAppManager.js:421-440](file://packages/main-app/src/core/microAppManager.js#L421-L440)
- [packages/main-app/src/core/microAppManager.js:292-313](file://packages/main-app/src/core/microAppManager.js#L292-L313)
...
**更新** 故障排查指南与新的文档索引结构相协调，便于运维人员快速定位相关问题。

**章节来源**
- [user-docs/guide/deployment.md:67-86](file://user-docs/guide/deployment.md#L67-L86)
- [packages/main-app/src/core/microAppManager.js:238-284](file://packages/main-app/src/core/microAppManager.js#L238-L284)
- [packages/main-app/src/core/microAppManager.js:340-375](file://packages/main-app/src/core/microAppManager.js#L340-L375)
- [packages/main-app/src/core/microAppManager.js:392-415](file://packages/main-app/src/core/microAppManager.js#L392-L415)
...
- 文档导航
  - 使用 VitePress 新的导航结构快速找到相关部署信息。
  - 通过文档索引页面按角色和功能查找部署相关内容。

**更新** 附录部分增加了新的文档导航信息，帮助运维人员更好地利用新的文档结构。

**章节来源**
- [README.md:28-38](file://README.md#L28-L38)
- [README.md:80-96](file://README.md#L80-L96)
- [package.json:10-29](file://package.json#L10-L29)
- [user-docs/.vitepress/config.js:8-13](file://user-docs/.vitepress/config.js#L8-L13)
- [user-docs/INDEX.md:105-115](file://user-docs/INDEX.md#L105-L115)